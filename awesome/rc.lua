...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "M", "A", "N", "D", "R", "I", "V", "A" }, s, awful.layout.layouts[1])
...
awful.spawn.with_shell("feh --bg-scale /home/lorenzo/Pictures/Pardus/pardusdigital.jpg")
awful.spawn.with_shell("nheko")
